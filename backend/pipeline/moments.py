...
_SYSTEM = (
    ...
    "- title: a punchy title for the Short, written in the SAME language the streamer "
    "speaks in this transcript (Russian transcript -> Russian title, English -> English title).\n"
